...
namespace ItsyBitsy.Bencoding.Tests
{
    public partial class BencodeSpanReaderTests
    {
        ...
        public static void ReadKeyLength_InInvalidState_ThrowsInvalidOperationException(string bencodeString, BTT[] tokenTypes)
        {
            ...
            var ex = AssertThrows<InvalidOperationException>(ref reader, (ref BencodeSpanReader r) => _ = r.ReadKeyLength());
        ...
        public static void ReadKey_InInvalidState_ThrowsInvalidOperationException(string bencodeString, BTT[] tokenTypes)
        {
            ...
            var ex = AssertThrows<InvalidOperationException>(ref reader, (ref BencodeSpanReader r) => _ = r.ReadKey());
        ...
        [TupleMemberData(nameof(BencodeTestData.InDictionaryValueState_DataAndTokens), MemberType = typeof(BencodeTestData))]
        [TupleMemberData(nameof(BencodeTestData.InFinalState_DataAndTokens), MemberType = typeof(BencodeTestData))]
        public static void TryReadKey_InInvalidState_ThrowsInvalidOperationException(string bencodeString, BTT[] tokenTypes)
        {
            byte[] bencode = bencodeString.ToUtf8();
            var reader = new BencodeSpanReader(bencode);
            Expect(ref reader, tokenTypes);

            var ex = AssertThrows<InvalidOperationException>(ref reader, (ref BencodeSpanReader r) => _ = r.TryReadKey(default, out _));

            Assert.Equal("The reader is not in a state that allows a key to be read.", ex.Message);
        }

        [Fact]
        public static void TryReadKey_InErrorState_ThrowsInvalidOperationException()
        {
            byte[] bencode = "d1:ae1ee".ToUtf8();
            var reader = new BencodeSpanReader(bencode);
            reader.ReadDictionaryHead();
        ...
        [Theory]
        [TupleMemberData(nameof(BencodeTestData.ReadString_ValidData_DataAndValue), MemberType = typeof(BencodeTestData))]
        public static void TryReadKey_ValidData_ReturnsTrueAndValue(string bencodeString, string expectedValueString)
        {
            byte[] expectedValue = expectedValueString.ToUtf8();
            byte[] bencode = $"d{bencodeString}i1ee".ToUtf8();
            var reader = new BencodeSpanReader(bencode);
        ...
        [Theory]
        [TupleMemberData(nameof(BencodeTestData.ReadString_ValidData_DataAndValue), MemberType = typeof(BencodeTestData))]
        public static void TryReadKey_ValidDataOversizedBuffer_ReturnsTrueAndValue(string bencodeString, string expectedValueString)
        {
            byte[] expectedValue = expectedValueString.ToUtf8();
            byte[] bencode = $"d{bencodeString}i1ee".ToUtf8();
            var reader = new BencodeSpanReader(bencode);
        ...
        [Theory]
        [TupleMemberData(nameof(BencodeTestData.ReadString_ValidData_DataAndValue), MemberType = typeof(BencodeTestData))]
        public static void TryReadKey_ValidDataUndersizedBuffer_ReturnsFalse(string bencodeString, string expectedValueString)
        {
            byte[] expectedValue = expectedValueString.ToUtf8();
        ...
        [Theory]
        [TupleMemberData(nameof(BencodeTestData.ReadString_ValidData_DataAndValue), MemberType = typeof(BencodeTestData))]
        public static void TryReadKey_ValidDataAfterReadKeyLength_ReturnsTrueAndValue(string bencodeString, string expectedValueString)
        {
            byte[] expectedValue = expectedValueString.ToUtf8();
            byte[] bencode = $"d{bencodeString}i1ee".ToUtf8();
            var reader = new BencodeSpanReader(bencode);
        ...
        [Theory]
        [TupleMemberData(nameof(BencodeTestData.ReadString_ValidData_DataAndValue), MemberType = typeof(BencodeTestData))]
        public static void TryReadKey_ValidData_PositionIsAfterKey(string bencodeString, string expectedValueString)
        {
            int keyBencodeLength = Encoding.UTF8.GetByteCount(bencodeString);
            byte[] expectedValue = expectedValueString.ToUtf8();
            byte[] bencode = $"d{bencodeString}i1ee".ToUtf8();
        ...
        [Theory]
        [TupleMemberData(nameof(BencodeTestData.ReadString_ValidData_DataAndValue), MemberType = typeof(BencodeTestData))]
        public static void TryReadKey_ValidDataOversizedBuffer_PositionIsAfterKey(string bencodeString, string expectedValueString)
        {
            int keyBencodeLength = Encoding.UTF8.GetByteCount(bencodeString);
            byte[] expectedValue = expectedValueString.ToUtf8();
            byte[] bencode = $"d{bencodeString}i1ee".ToUtf8();
        ...
        [Theory]
        [TupleMemberData(nameof(BencodeTestData.ReadString_ValidData_DataAndValue), MemberType = typeof(BencodeTestData))]
        public static void TryReadKey_ValidDataUndersizedBuffer_PositionIsUnchanged(string bencodeString, string expectedValueString)
        {
            byte[] expectedValue = expectedValueString.ToUtf8();
            if (expectedValue.Length == 0)
                return;
        ...
        [Theory]
        [TupleMemberData(nameof(BencodeTestData.ReadString_ValidData_DataAndValue), MemberType = typeof(BencodeTestData))]
        public static void TryReadKey_ValidDataAfterReadKeyLength_PositionIsAfterKey(string bencodeString, string expectedValueString)
        {
            int keyBencodeLength = Encoding.UTF8.GetByteCount(bencodeString);
            byte[] expectedValue = expectedValueString.ToUtf8();
            byte[] bencode = $"d{bencodeString}i1ee".ToUtf8();
        ...
        public static void ReadKeyLength_MissingHeadData_ThrowsInvalidBencodeExceptionAndGoesToErrorState(string bencodeString, string errorMessage, int errorPosition)
        {
            ...
            var ex = AssertThrows<InvalidBencodeException>(ref reader, (ref BencodeSpanReader r) => _ = r.ReadKeyLength());
            int position = reader.Position;
        ...
        public static void ReadKey_MissingData_ThrowsInvalidBencodeExceptionAndGoesToErrorState(string bencodeString, string errorMessage, int errorPosition)
        {
            ...
            var ex = AssertThrows<InvalidBencodeException>(ref reader, (ref BencodeSpanReader r) => _ = r.ReadKey());
            int position = reader.Position;
            var errorTokenType = reader.ReadTokenType();
        ...
        public static void TryReadKey_MissingData_ThrowsInvalidBencodeExceptionAndGoesToErrorState(string bencodeString, int expectedLength, string errorMessage, int errorPosition)
        {
            ...
            var ex = AssertThrows<InvalidBencodeException>(ref reader, (ref BencodeSpanReader r) => _ = r.TryReadKey(value, out _));
            int position = reader.Position;
            var errorTokenType = reader.ReadTokenType();
        ...
        public static void TryReadKey_InvalidData_ThrowsInvalidBencodeExceptionAndGoesToErrorState(string bencodeString, int expectedLength, string errorMessage, int errorPosition)
        {
            if (expectedLength > 4096)
                return;
        ...
        [Theory]
        [TupleMemberData(nameof(BencodeTestData.ReadString_MissingBodyData_DataAndLengthAndError), MemberType = typeof(BencodeTestData))]
        public static void TryReadKey_MissingBodyDataOversizedBuffer_ThrowsInvalidBencodeExceptionAndGoesToErrorState(string bencodeString, int expectedLength, string errorMessage, int errorPosition)
        {
            if (expectedLength > 4096)
                return;
        ...
        [Theory]
        [TupleMemberData(nameof(BencodeTestData.ReadString_MissingBodyData_DataAndLength), MemberType = typeof(BencodeTestData))]
        public static void TryReadKey_MissingBodyDataUndersizedBuffer_ReturnsFalse(string bencodeString, int expectedLength)
        {
        ...
        [Theory]
        [TupleMemberData(nameof(BencodeTestData.ReadString_MissingBodyData_DataAndLengthAndError), MemberType = typeof(BencodeTestData))]
        public static void TryReadKey_MissingBodyDataAfterReadStringLength_ThrowsInvalidBencodeExceptionAndGoesToErrorState(string bencodeString, int expectedLength, string errorMessage, int errorPosition)
        {
            if (expectedLength > 4096)
                return;
        ...
        [Theory]
        [TupleMemberData(nameof(BencodeTestData.ReadString_MissingBodyData_DataAndLength), MemberType = typeof(BencodeTestData))]
        public static void TryReadKey_MissingBodyDataUndersizedBuffer_PositionIsUnchanged(string bencodeString, int expectedLength)
        {
            if (expectedLength == 0 || expectedLength > 4096)
                return;
        ...
        public static void ReadKeyLength_UnsupportedData_ThrowsUnsupportedBencodeExceptionAndGoesToErrorState(string bencodeString, string errorMessage, int errorPosition, int expectedPosition)
        {
            ...
            var ex = AssertThrows<UnsupportedBencodeException>(ref reader, (ref BencodeSpanReader r) => _ = r.ReadKeyLength());
            int position = reader.Position;
            var errorTokenType = reader.ReadTokenType();
        ...
        public static void ReadKey_UnsupportedData_ThrowsUnsupportedBencodeExceptionAndGoesToErrorState(string bencodeString, string errorMessage, int errorPosition, int expectedPosition)
        {
            ...
            var ex = AssertThrows<UnsupportedBencodeException>(ref reader, (ref BencodeSpanReader r) => _ = r.ReadKey());
            int position = reader.Position;
            var errorTokenType = reader.ReadTokenType();
        ...
        [Theory]
        [TupleMemberData(nameof(BencodeTestData.ReadString_UnsupportedData_DataAndErrorAndPosition), MemberType = typeof(BencodeTestData))]
        public static void TryReadKey_UnsupportedData_ThrowsUnsupportedBencodeExceptionAndGoesToErrorState(string bencodeString, string errorMessage, int errorPosition, int expectedPosition)
        {
            byte[] bencode = $"d{bencodeString}i1ee".ToUtf8();
            var reader = new BencodeSpanReader(bencode);
            ...
            var ex = AssertThrows<UnsupportedBencodeException>(ref reader, (ref BencodeSpanReader r) => _ = r.TryReadKey(value, out _));
            int position = reader.Position;
            var errorTokenType = reader.ReadTokenType();
