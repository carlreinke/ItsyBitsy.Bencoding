...
namespace ItsyBitsy.Bencoding.Tests
{
    ...
    {
        [Fact]
        public static void ReadKeyToIBencodeWriter_WriterIsNull_ThrowsArgumentNullException()
        {
            byte[] bencode = "d1:ai1ee".ToUtf8();
            var reader = new BencodeSpanReader(bencode);
            reader.ReadDictionaryHead();

            var ex = AssertThrows<ArgumentNullException>(ref reader, (ref BencodeSpanReader r) => r.ReadKeyTo(null));
        ...
        public static void ReadKeyToIBencodeWriter_InInvalidState_ThrowsInvalidOperationException(string bencodeString, BTT[] tokenTypes)
        {
        ...
        [Fact]
        public static void ReadKeyToIBencodeWriter_InErrorState_ThrowsInvalidOperationException()
        {
        ...
        public static void ReadKeyToIBencodeWriter_Always_WritesExpectedData(string bencodeString)
        {
        ...
        [Theory]
        [TupleMemberData(nameof(BencodeTestData.ReadString_ValidData_Data), MemberType = typeof(BencodeTestData))]
        public static void ReadKeyToIBencodeWriter_ValidData_PositionIsAfterKey(string bencodeString)
        {
        ...
        [Theory]
        [TupleMemberData(nameof(BencodeTestData.ReadString_ValidData_Data), MemberType = typeof(BencodeTestData))]
        public static void ReadKeyToIBencodeWriter_ValidDataAfterReadKeyLength_PositionIsAfterKey(string bencodeString)
        {
            int keyBencodeLength = Encoding.UTF8.GetByteCount(bencodeString);
            byte[] bencode = $"d{bencodeString}i1ee".ToUtf8();
            var reader = new BencodeSpanReader(bencode);
        ...
        public static void ReadKeyToBencodeWriter_MissingData_ThrowsInvalidBencodeExceptionAndGoesToErrorState(string bencodeString, string errorMessage, int errorPosition)
        {
        ...
        public static void ReadKeyToBencodeWriter_InvalidData_ThrowsInvalidBencodeExceptionAndGoesToErrorState(string bencodeString, string errorMessage, int errorPosition)
        {
            byte[] bencode = $"d{bencodeString}i1ee".ToUtf8();
            var reader = new BencodeSpanReader(bencode);
            reader.ReadDictionaryHead();
        ...
        [Theory]
        [TupleMemberData(nameof(BencodeTestData.ReadString_MissingBodyData_DataAndError), MemberType = typeof(BencodeTestData))]
        public static void ReadKeyToBencodeWriter_MissingBodyDataAfterReadStringLength_ThrowsInvalidBencodeExceptionAndGoesToErrorState(string bencodeString, string errorMessage, int errorPosition)
        {
            byte[] bencode = $"d{bencodeString}".ToUtf8();
            var reader = new BencodeSpanReader(bencode);
            reader.ReadDictionaryHead();
        ...
        public static void ReadKeyToIBencodeWriter_UnsupportedData_ThrowsUnsupportedBencodeExceptionAndGoesToErrorState(string bencodeString, string errorMessage, int errorPosition, int expectedPosition)
        {
            byte[] bencode = $"d{bencodeString}i1ee".ToUtf8();
            var reader = new BencodeSpanReader(bencode);
            reader.ReadDictionaryHead();
