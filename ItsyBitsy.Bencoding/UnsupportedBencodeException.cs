...
{
    /// <summary>
    /// Represents an error caused by parsing bencode that may be valid but is not supported by the
    /// parser.
    /// </summary>
    [Serializable]
    public class UnsupportedBencodeException : BencodeException
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnsupportedBencodeException"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UnsupportedBencodeException"/> class with
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UnsupportedBencodeException"/> class with
        /// the specified error message and inner exception that is the cause of this exception.
        /// </summary>
        /// <param name="message">The error message.</param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UnsupportedBencodeException"/> class with
        /// the specified error message and position in the stream where the error occurred.
        /// </summary>
        /// <param name="message">The error message.</param>
